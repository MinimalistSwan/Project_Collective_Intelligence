...
with_flocking_df = pd.read_csv('Assignments/Assignment_2/Results/AvgEnergyFlocking.csv')
no_flocking_df = pd.read_csv('Assignments/Assignment_2/Results/AvgEnergyNoFlocking.csv')
